...
export const furnitureKinds=['sofa','table','counter','bed','shelf','chair','rug','armchair','tv','bathtub','vanity','toilet','radiator','dresser','wardrobe','nightstand','mirror','tilePanel','ledge','barstool','kitchenPendant','kitchenSplash','pantryDoor','windowBlind','wallClock','ceilingSpot','diningStorage','diningWallpaper','diningCove','diningPendant','diningBench','diningPlant','studioDesk','studioChair','studioShelf','studioBeam','studioLamp','brewCabinet','brewFridge','brewBar','brewRack','brewBench','brewChair','brewPanel','brewShelves','brewReceiver','brewSign','brewTable','brewPendant','livingOttoman','livingCoffee','livingMedia','livingSpeaker','livingArt','livingWall','livingCurtain'] as const;
export const kitchenKinds=['drawers','fridge','oven','sink','dishwasher','hob','corner'] as const;
export interface Furniture { kind:typeof furnitureKinds[number]; rect:Rect; height:number; bottom?:number; facing?:'north'|'south'|'east'|'west'; kitchen?:typeof kitchenKinds[number]; finish?:'dining'|'living'; workstation?:'wide'|'standard' }
